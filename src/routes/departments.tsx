    ...
    <div>
      ...
      <section className="pb-20">
        <div className="mx-auto max-w-7xl px-4 space-y-12">
          {services.map((d, i) => (
            <AnimatedSection key={d.name} animation={i % 2 === 0 ? "fade-left" : "fade-right"} delay={100}>
              <div className={`rounded-2xl bg-card border border-border shadow-card overflow-hidden ${i % 2 === 1 ? "lg:flex-row-reverse" : ""}`}>
