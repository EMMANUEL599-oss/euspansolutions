...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ICT & Digital Solutions — Unlocking Digital Opportunities Globally & Reducing Unemployment" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "euspansolutions" },
      { property: "og:description", content: "ICT & Digital Solutions — Unlocking Digital Opportunities Globally & Reducing Unemployment" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "euspansolutions" },
      { name: "twitter:description", content: "ICT & Digital Solutions — Unlocking Digital Opportunities Globally & Reducing Unemployment" },
